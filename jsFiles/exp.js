    ...
    const html = {
        intro: [
            ...
            `<div class='parent'>
                ...
                <p>Specifially, you'll report how <strong>immersed and engaged</strong> you feel while spinning each wheel,<br>
...
const timeline = [exp.intro, exp.task, exp.demographics, exp.save_data];
